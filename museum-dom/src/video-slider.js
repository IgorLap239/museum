const videoSlider = () => {
  ...
  class SliderCarousel {
    constructor() {
      this.main = document.querySelector(`.video-slider-wrapper`);
      this.wrap = this.main.querySelector('.video-playlist');
      this.slides = this.main.querySelectorAll('.video-item');
      this.slidesToShow = 3;
      ...
      this.playlistNav = this.main.querySelector('.playlist-control');
      this.prev = this.playlistNav.querySelector('.left-switch');
      this.next = this.playlistNav.querySelector('.rigth-switch');
      this.sliderDots = this.playlistNav.querySelectorAll('.slide-dot');
    }
    ...
    controlSlider() {
      ...
      this.playlistNav.addEventListener('click', this.controlSliderDots.bind(this))
    }
